                        ...
                        ` : jobTypes.map((jobType, index) => `
                            <div class="admin-list-item ${jobType.id === activeJobTypeId ? 'active-job-type' : ''}">
                                ...
                                <div class="admin-item-actions">
                                    ...
                                    <button class="button-icon-sm icon-btn-danger" onclick="deleteJobType(${index})">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        return `
            <div class="admin-list-item" style="margin-bottom: var(--spacing-sm);">
                ...
                <div class="admin-item-actions">
                    ...
                    <button class="button-icon-sm icon-btn-danger" onclick="deleteSurveyQuestion(${index})">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <polyline points="3 6 5 6 21 6"></polyline>
                            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                        </svg>
    ...
    container.innerHTML = tempMaterials.map((m, index) => `
        <div class="admin-list-item" style="margin-bottom: var(--spacing-sm);">
            ...
            <div class="admin-item-actions">
                ...
                <button class="button-icon-sm icon-btn-danger" onclick="deleteJobTypeMaterialItem(${index})">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <polyline points="3 6 5 6 21 6"></polyline>
                        <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                    </svg>
